...
📦 What's Inside? Kodi Wizard: Automatically installs the latest builds.

Kodi Builds: Custom setups optimized for performance and simplicity.

🔧 Why This Exists As a frugal IT dad, I built this to make it easy for my loved ones to:
...
🚀 First-Time Setup Install Kodi (recommended: latest stable version).
...
⚠️ Disclaimer This project is for personal and private use only. It is shared with friends and family for educational and entertainment purposes. No content is hosted here — Kodi and addons are installed from their official sources.

💬 Questions? If you're one of my friends or family and need help, just call or text me like always. 😉
